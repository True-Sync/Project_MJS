...
public:
	...
	BEGIN_SHADER_PARAMETER_STRUCT(FParameters, )
		...
		// 존 분류
			...
			SHADER_PARAMETER(FVector3f, KeyLightDirection)

		// Zone B — 캐릭터
		SHADER_PARAMETER(float,     CharacterContrastBoost)
		SHADER_PARAMETER(float,     CharacterSaturationBoost)
			SHADER_PARAMETER(float,     CharacterCelShadingStrength)
			SHADER_PARAMETER(float,     CharacterCelShadowThreshold)
			SHADER_PARAMETER(float,     CharacterCelShadowSoftness)
			SHADER_PARAMETER(float,     CharacterCelShadowDepth)
			SHADER_PARAMETER(FVector3f, CharacterCelShadowTint)
			SHADER_PARAMETER(float,     CharacterRimIntensity)
			SHADER_PARAMETER(float,     CharacterRimPower)
			SHADER_PARAMETER(float,     CharacterDirectionalRimStrength)
			SHADER_PARAMETER(float,     CharacterDirectionalRimLightStart)
			SHADER_PARAMETER(float,     CharacterDirectionalRimLightEnd)
			SHADER_PARAMETER(float,     CharacterDirectionalRimLightWrap)
		...
		SHADER_PARAMETER(float,     EnvCelShadingStrength)
		SHADER_PARAMETER(float,     EnvCelShadowThreshold)
		SHADER_PARAMETER(float,     EnvCelShadowSoftness)
		SHADER_PARAMETER(float,     EnvCelShadowDepth)
		SHADER_PARAMETER(FVector3f, EnvCelShadowTint)
		SHADER_PARAMETER(float,     EnvCelFadeStartDistance)
		SHADER_PARAMETER(float,     EnvCelFadeEndDistance)
		...
		SHADER_PARAMETER(float,     BackgroundWhiteRimFadeStartDistance)
		SHADER_PARAMETER(float,     BackgroundWhiteRimFadeEndDistance)
